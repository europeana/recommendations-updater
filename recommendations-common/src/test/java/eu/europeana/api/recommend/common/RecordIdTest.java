...
public class RecordIdTest {
    ...
    public void recordIdMilvusTestTooLong() {
        String datasetId = "0";
        String localId = "0123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789";
        RecordId rId = new RecordId(datasetId, localId);
        assertEquals("0/01234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567", rId.getMilvusId());
    }
