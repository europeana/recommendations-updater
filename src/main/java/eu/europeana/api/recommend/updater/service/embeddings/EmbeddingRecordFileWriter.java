 ...
 */
public class EmbeddingRecordFileWriter extends FlatFileItemWriterBuilder<EmbeddingRecord> {
     ...
     */
    public EmbeddingRecordFileWriter(String fileName) {
        this.fileName = fileName;
    }

    @Override
    public FlatFileItemWriter<EmbeddingRecord> build() {
    ...
    private LineAggregator<EmbeddingRecord> createLineAggregator() {
        return embeddingRecord -> {
            StringBuilder s = new StringBuilder(200); // rough estimate of average size
